...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            dataframe = sensor_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config)
    ...
    def split_data_as_train_test(self,dataframe:DataFrame)->None:
        """
        Feature store dataset will be split into train & test file
        """
        try:
